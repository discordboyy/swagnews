...
export const feedItems: FeedItem[] = [
  {
    ...
    image: 'link/content/another/MIXXTALES.png',
    emoji: 'link/span/span-emoji 10.png',
    size: 'short',
...
Реліз заплановано на 16 травня 2025 року на всіх стрімінгових платформах.`,
  ...
  },
  {
    ...
    emoji: 'link/span/span-emoji 08.png',
    size: 'short',
  ...
  },
  {
    ...
    image: 'link/content/créative web/ai.png',
    emoji: 'link/span/span-emoji 01.png',
    size: 'short',
  ...
  },
  {
    ...
    image: 'link/content/créative web/Скетчі – ваш скарб!.png',
    emoji: 'link/span/span-emoji 02.png',
    size: 'short',
  ...
  },
  {
    ...
    image: 'link/content/créative web/Як знайти референси для свого портфоліо.png',
  ...
  },
  {
    ...
    image: 'link/content/créative web/Що таке айдентика.png',
    size: 'short',
  ...
  },
  {
    ...
    image: 'link/content/créative web/Що таке стиль.png',
    imagePosition: 'bottom',
    size: 'short',
  ...
  },
  {
    ...
    image: 'link/content/créative web/sicko.png',
    size: 'short',
...
export const sidebarItems: SidebarItem[] = [
  {
    id: 'gumroad-pack',
    image: 'link/content/créative web/Cover gumroad (3).png',
  ...
  {
    id: 'brand-tg',
    image: 'link/content/créative web/INDEPENDENT INTERNATIONAL UKRAINIAN KIDS.png',
  ...
  {
    id: 'csgo-work',
    image: 'link/content/créative web/lol relationshit.png',
